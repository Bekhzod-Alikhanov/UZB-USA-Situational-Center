...
export const sources: Source[] = [
  ...
  {
    id: "input_roadmap_samarkand_docx",
    level: "A",
    name: "Samarkand region roadmap — agreements from the US delegation visit (10–17 May 2026)",
    sourceFile: "input/2. Самарқанд (АҚШ).docx",
    fetched_at: "2026-07-04",
    data_type: "Hokimiyat-approved roadmap: 48 projects, $1.5B, tasks with deadlines and responsible officials",
    note: "Uzbek Cyrillic original; ingested verbatim with Russian translations in data/roadmaps.ts.",
  },
  {
    id: "input_roadmap_khorezm_docx",
    level: "A",
    name: "Khorezm region roadmap — agreements from the US delegation visit (26–31 May 2026)",
    sourceFile: "input/3. Хоразм (АҚШ).docx",
    fetched_at: "2026-07-04",
    data_type: "Hokimiyat-approved roadmap: 13 projects, $1.0B, tasks with deadlines and responsible officials",
    note: "Uzbek Cyrillic original; ingested verbatim with Russian translations in data/roadmaps.ts.",
  },
  {
