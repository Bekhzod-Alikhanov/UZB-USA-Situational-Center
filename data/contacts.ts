...
export const contacts: Contact[] = [
  ...
  },
  {
    ...
    people: [
      { name: "Carolyn B. Lamm", role: "Co-founder & senior counsel", side: "us", is_demo: false },
    ],
    is_demo: false,
  ...
  },
  {
    ...
    people: [
      ...
      { name: "Komil Allamjonov", role: "Special Envoy; Advisor to the Head of the Administration of the President", side: "uz", is_demo: false },
      { name: "Nozima Davletova", role: "Head of Council Secretariat", side: "uz", is_demo: false },
      { name: "Timur Ishmetov", role: "Chairman, Central Bank of the Republic of Uzbekistan", side: "uz", is_demo: false },
      { name: "Shukhrat Vafaev", role: "Executive Director, Fund for Reconstruction and Development of Uzbekistan", side: "uz", is_demo: false },
      ...
      { name: "David L. Fogel", role: "Assistant Secretary of Commerce; Director General, U.S. and Foreign Commercial Service", side: "us", is_demo: false },
      { name: "Isabel Galdiz", role: "Vice President, International Relations Division, EXIM", side: "us", is_demo: false },
      { name: "Bethany Brez", role: "Vice President, Office of Foreign Policy, DFC", side: "us", is_demo: false },
      { name: "Caleb Orr", role: "Assistant Secretary of State for Economic, Energy, and Business Affairs", side: "us", is_demo: false },
