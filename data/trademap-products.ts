...
export const uzExportsToUs2024Top: TrademapProduct2024[] = [
  ...
  },
  {
    hs: "711292",
    labelRu:
      "Прочие отходы платины, включая металл, плакированный платиной, но исключая отходы, содержащие другие драгоценные металлы",
    valueUsd: 5706000,
    quantity: 70,
  ...
  },
  {
    hs: "681599",
    labelRu:
      "Изделия из камня или других минеральных веществ (включая углеродные волокна, изделия из углеродных волокон и изделия из торфа), в другом месте не поименованные или не включенные:прочие",
    valueUsd: 525000,
    quantity: 221,
  ...
  },
  {
    hs: "841899",
    labelRu:
      "Прочие части холодильников, морозильников и прочего холодильного или морозильного оборудования электрического или других типов",
    valueUsd: 329000,
    quantity: null,
    unitValueUsd: null,
  ...
  },
  {
    hs: "854320",
    labelRu:
      "Машины электрические и аппаратура, имеющие индивидуальные функции, в другом месте данной группы не поименованные или не включенные, генераторы сигналов",
    valueUsd: 327000,
    quantity: 1762,
  ...
  },
  {
    hs: "760612",
    labelRu:
      "Плиты, листы, полосы или ленты прямоугольные (включая квадратные), толщиной более 0,2 мм, из алюминиевых сплавов",
    valueUsd: 103000,
    quantity: 25,
    unitValueUsd: 4120,
  ...
  },
  {
    hs: "220299",
    labelRu:
      "Прочие воды, включая минер-е и газир-е, сод. добавки сахара или вкусо-ароматических веществ, и пр. безалког. напитки, за исключением  фрукт-х или овощных соков товарной позиции 2009",
    valueUsd: 101000,
    quantity: 122,
  ...
  },
  {
    hs: "200190",
    labelRu:
      "Прочие овощи, фрукты, орехи и другие съедобные части растений, приготовленные или консервированные c добавлением уксуса или уксусной кислоты",
    valueUsd: 97000,
    quantity: 128,
  ...
  },
  {
    hs: "071331",
    labelRu:
      "Фасоль видов vinga mungo (l.) hepper или vinga radiata(l.) wilczek сушеная, лущеная, очищенная от семенной кожуры или неочищенная, колотая или неколотая",
    valueUsd: 91000,
    quantity: 52,
    unitValueUsd: 1750,
...
export const usExportsToUz2024Top: TrademapProduct2024[] = [
  ...
  },
  {
    hs: "481151",
    labelRu:
      "Бумага и картон с покрытием, пропиткой или ламинированные пластмассой (за искл.клеев) беленые, массой 1 м2 более 150 г",
    valueUsd: 2706000,
    quantity: 204,
  ...
  },
  {
    hs: "850213",
    labelRu:
      "Установки электрогенераторные с поршневым двигателем внутреннего сгорания с воспламенением от сжатия мощностью более 375 ква",
    valueUsd: 2646000,
    quantity: 8,
    unitValueUsd: 330750,
  ...
  },
  {
    hs: "901580",
    labelRu:
      "Прочие приборы и инструменты топографические, гидрографические,  океанографические, гидрологические, метеорологические или геофизические, кроме компасов, электронные",
    valueUsd: 2261000,
    quantity: null,
    unitValueUsd: null,
  ...
  },
  {
    hs: "840790",
    labelRu:
      "Прочие двигатели внутреннего сгорания с искровым зажиганием, с вращающимися или возвратно-поступательным движением поршня",
    valueUsd: 2082000,
    quantity: 8,
    unitValueUsd: 260250,
  ...
  },
  {
    hs: "470321",
    labelRu:
      "Целлюлоза древесная,натронная или сульфатная,кроме растворимых сортов,полуббеленая или беленая,из хвойных пород",
    valueUsd: 1563000,
    quantity: 1844,
  ...
  },
  {
    hs: "847130",
    labelRu:
      "Машины вычислительные цифровые портативные массой не более 10 кг, содержащие, по крайней мере,из центрального блока обработки данных, клавиатуры и дисплея",
    valueUsd: 1489000,
    quantity: 5264,
  ...
  },
  {
    hs: "840991",
    labelRu:
      "Части, предназначенные исключительно или главным образом для поршневых д игателей внутреннего сгорания с искровым зажиганием товарной позиции 8407 или 8408",
    valueUsd: 1361000,
    quantity: 45,
  ...
  },
  {
    hs: "847150",
    labelRu:
      "Блоки вычислит.машин,блоки обработки данных, отличные от описанных в субпозиции 8471 41 или 8471 49, содержащ.или не содержащ.в одном корпусе одноили два из следующих устр-в:запоминающее,ввода,вывода",
    valueUsd: 1209000,
    quantity: 482,
  ...
  },
  {
    hs: "870323",
    labelRu:
      "Транспортные средства с двигателем внутреннего сгорания с искровым  зажиганием и с возвратно-поступат. движением поршня, с раб. объемом цилиндров более 1500 см3, но не более 3000 см3",
    valueUsd: 1090000,
    quantity: 55,
  ...
  },
  {
    hs: "731815",
    labelRu:
      "Винты и болты прочие, из черных металлов, снабженные резьбой, в комплекте с гайками или шайбами или без них",
    valueUsd: 1083000,
    quantity: 142,
  ...
  },
  {
    hs: "847141",
    labelRu:
      "Машины вычислительн. прочие, содерж в одном корпусе, по крайней мере,центр. блок обр-ки данных и устр-во вв. и выв, объединенные или нет",
    valueUsd: 983000,
    quantity: 111,
  ...
  },
  {
    hs: "870324",
    labelRu:
      "Транспортные средства с двигателем внутреннего сгорания с искровым  зажиганием и с возвратно-поступательным движением поршня, с рабочим объемом цилиндров  двигателя более 3000 см3",
    valueUsd: 973000,
    quantity: 19,
