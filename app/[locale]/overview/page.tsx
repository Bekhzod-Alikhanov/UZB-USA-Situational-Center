...
/**
 * /overview — the staff working dashboard (full analytical drill-down).
 * The site landing page ("/") is now the executive brief; this page keeps
 * the depth: trade editorial, full sector grid, partners, risk radar,
 * 90-day horizon, grants. Slimmed in the brief-home pass: the MicroKpi
 * strip (duplicated the landing KPI band) and the platform-mandate prose
 * were removed; the command center collapsed behind a summary row.
 */
