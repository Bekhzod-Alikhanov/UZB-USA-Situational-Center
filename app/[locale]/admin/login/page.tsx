      ...
      <Card className="w-full max-w-md">
        ...
        <CardBody>
          <form action={login} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center gap-2 rounded-md bg-[var(--color-primary)] px-4 py-2 text-[13px] font-medium text-[var(--color-primary-contrast)] transition hover:bg-[var(--color-primary-2)]"
            >
              {t("submit")}
            </button>
