...
| 3D globe                             | Removed in 2026-05-15 safe cleanup                                                                                                       | Previously provided spatial/executive polish.               | Unused runtime feature with heavy texture/dependency cost.           | N/A.                                                           | Removed without route/API/schema changes.            | Low: no production import existed.                                    | Keep removed unless a future design explicitly reintroduces a lighter map surface. | High       |
