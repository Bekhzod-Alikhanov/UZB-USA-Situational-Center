...
| `map.png`       | ~1400 × 900 px   | `/en/map` — choropleth with mission pins visible                   |
| `trade.png`     | ~1400 × 900 px   | `/en/trade` — Annual summary + Dual-methodology + Trade Flow chart |
| `sectors.png`   | ~1400 × 900 px   | `/en/sectors` — sector-opportunity cards grid                      |
| `benchmark.png` | ~1400 × 900 px   | `/en/benchmark` — UZ rank · UZ value · vs peer average + bar chart |
