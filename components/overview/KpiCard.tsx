...
// Executive KPIs do not pass is_demo, so the rendered tree is pure SSR.
...
export function KpiCard({
  ...
  if (href) {
    return (
      <Link href={href} prefetch={false} style={style} className={cn("kpi-card group block", className)}>
        {inner}
      </Link>
    );
  }
