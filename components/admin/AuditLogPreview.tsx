...
const LOG: Entry[] = [
  ...
  },
  {
    ...
    ts: "2026-04-20 10:02",
    actor: "k.abdukodirov",
    action: "created delegation",
    entity: "d-1 MIIT roadshow",
    tone: "info",
  },
  {
    id: "l-4",
  ...
  },
  {
    ...
    ts: "2026-04-19 09:15",
    actor: "system",
    action: "OFAC status refreshed",
    entity: "data/compliance.ts",
    tone: "ok",
  },
];
  ...
  return (
    <ul className="flex flex-col gap-1.5">
      {LOG.map((e) => (
        ...
        >
          <span className="mono w-[120px] shrink-0 text-[10.5px] tabular text-[var(--color-ink-muted)]">{e.ts}</span>
