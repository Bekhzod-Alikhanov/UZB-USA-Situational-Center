...
const SEED: Task[] = [
  { id: "t-01", stage: "plan", title: "Confirm delegation composition (11 members — optimizer result)", owner: "Presidential Admin.", due: "D-30", priority: "high" },
  { id: "t-02", stage: "plan", title: "Draft working agenda (3 parallel tracks)", owner: "MFA", due: "D-28", priority: "high" },
  { id: "t-03", stage: "plan", title: "Lock bilateral meeting list (Rubio, Waltz, Gor, Landau)", owner: "MFA + Embassy DC", due: "D-25" },
  { id: "t-04", stage: "plan", title: "Coordinate Trump-side window + fallback slot", owner: "Presidential Admin.", due: "D-25", priority: "high" },

  { id: "t-05", stage: "coord", title: "Letter of request to State Department", owner: "MFA", due: "D-21" },
  { id: "t-06", stage: "coord", title: "Venue and security clearance (Blair House / St. Regis)", owner: "SSO", due: "D-18" },
  { id: "t-07", stage: "coord", title: "Protocol schedule (gifts, anthems, seating)", owner: "Protocol Dept.", due: "D-16" },
  { id: "t-08", stage: "coord", title: "Press plan + pool list", owner: "Press service", due: "D-14" },

  { id: "t-09", stage: "brief", title: "Counterparts pack — 14 briefing cards", owner: "MFA Americas Dept.", due: "D-10" },
  { id: "t-10", stage: "brief", title: "Trade talking points — $1.0B turnover, balance −$420M", owner: "MIIT", due: "D-10" },
  { id: "t-11", stage: "brief", title: "Critical Minerals follow-up dossier", owner: "MinEnergy", due: "D-8" },
  { id: "t-12", stage: "brief", title: "Opposition-research memo for Congress outreach", owner: "Embassy DC", due: "D-7" },

  { id: "t-13", stage: "exec", title: "President's plenary — statement drafts (EN/UZ)", owner: "Speechwriting", due: "D-3", priority: "high" },
  ...
  { id: "t-17", stage: "follow", title: "Commitments registry update (10–15 new items)", owner: "Situational Center", due: "D+5" },
...
export function KanbanBoard() {
  ...
  function onDragEnd(e: DragEndEvent) {
    ...
    setTasks((list) =>
      list.map((t) => (t.id === active.id ? { ...t, stage: overStage } : t)),
    );
  }
      ...
      <div className="flex items-start gap-1.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 flex flex-wrap items-center gap-1.5 text-[10px]">
            ...
            {task.due ? (
              <span className="mono text-[var(--color-ink-muted)]">{task.due}</span>
            ) : null}
            {task.priority === "high" ? (
