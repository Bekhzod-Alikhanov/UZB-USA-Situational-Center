...
| `input/Данные к US_SC/Грант 2025/Грант_по_проектно.xlsx` | parsed | `data/grants.ts` (7 rows × $15.381M) | Workbook title: *Grant mablag'larini jalb qilish to'g'risida ma'lumot* (07.01.2026). |
