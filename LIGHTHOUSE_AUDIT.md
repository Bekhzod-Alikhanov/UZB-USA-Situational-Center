...
- **LCP (Largest Contentful Paint) ≈ 3.7–4.7 s on all routes** — that 2–3 s gap between FCP and LCP is the universal villain. The hero card / KPI row is being painted 2–4× *after* the first frame because it depends on chunks of JS that arrive late.
